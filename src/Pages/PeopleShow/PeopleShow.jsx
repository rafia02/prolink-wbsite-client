    ...
    return (
        <div className=' bg-white pt-5 px-5'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-14'>
                <div className='mt-20'>
                    <h1 className='text-[48px] mb-10 font-thin  '>Welcome to your professional <span className='text-purple-800 font-mono italic text-[50px] font-semibold'>Prolink</span> community</h1>
                    <Link className='px-14 py-[10px] rounded-lg text-xl hover:bg-purple-900 duration-700  font-bold bg-purple-700 text-white '>Log in</Link>
                </div>
                <div>  
            ...
            <div className='grid grid-cols-1 mr-14 my-40  md:grid-cols-2 gap-14'>
                ...
                <div className=''>  
                <button className=' hover:bg-purple-100 text-purple-900 mt-9 ml-32 duration-700 font-bold px-4 py-3 border-2 text-lg border-purple-700 rounded-full mb-5 mr-3'>Post a job</button>
                </div>
            </div>
